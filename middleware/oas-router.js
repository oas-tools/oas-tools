...
exports = module.exports = function(controllers) {
  return function OASRouter(req, res, next) {
    ...
    } else if (existsController(controllers, utils.generateName(req.route.path, "controller"))){ //oasDoc file doesn't have router_property: use the standard controller name (autogenerated) if found
      var controllerName = utils.generateName(req.route.path, "controller");
