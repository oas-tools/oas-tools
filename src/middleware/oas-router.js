...
function nameOfPath(reqPath) {
  var res = reqPath.toString().substring(1, reqPath.length).toString(); //TODO: handle paths like /pets/{petId} the right way!
  return res;
}
...
exports = module.exports = function(controllers) {
  ...
  return function OASRouter(req, res, next) {
    ...
    } else if (existsController(controllers, generateName(requestedUrl))) { //spec file doesn't have x-router-controllers property: use the standard controller name (autogenerated) if found
