...
function generateControllerName(url) {
  return resourceName(url) + "Controllers";
}
...
exports = module.exports = function(controllers) {
  ...
  return function OASRouter(req, res, next) {
    ...
    } else if (existsController(controllers, generateControllerName(requestedUrl))) { //oasDoc file doesn't have x-router-controllers property: use the standard controller name (autogenerated) if found
