...
exports = module.exports = function(controllers) {
  return function OASRouter(req, res, next) {
    ...
    } else if (existsController(controllers, generateControllerName(req.path))) { //oasDoc file doesn't have router_property: use the standard controller name (autogenerated) if found
