          ...
          for (path in paths) {
            for (var method in paths[path]) {
              if (paths[path][method].operationId != undefined) {
                ...
                opId = generateOperationId(method, path); //nameMethod(method) + getBasePath(path);
              ...
              if (!controller_files.includes(controllerName)) {
                ...
                var header = "'use strict' \n\nvar " + normalize_controllerName(controllerName) + " = require('./" + controllerName + "Service');\n\n";
              ...
              var function_string = "module.exports." + opId + " = function " + opId + " (req, res, next) {\n" + normalize_controllerName(controllerName) + "." + opId + "(req.swagger.params, res, next);\n};\n\n";
